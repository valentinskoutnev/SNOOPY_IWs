...
struct Parameters {
    ...
    double forcing_tcorr;   /**< Correlation time of forcing if using FORCING_TCORR */
    double forcing_level;   /**< Correlation time of forcing if using FORCING_TCORR */
	...
	int		subtract_base_flow_IW;	/**< Subtract baseflow from the 3D snapshots */
	...
	double per_amplitude_large_U;		/**< Amplitude of the large scale random noise */
	double per_amplitude_large_B;		/**< Amplitude of the large scale random noise */
