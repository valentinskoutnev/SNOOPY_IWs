...
/*
        outputAm0l(fldi,t);
    	outputUUTransferSpectrum(fldi,t,0);
        outputUUTransferSpectrum(fldi,t,1);        
        outputTransferSpectrum(fldi,t,0);
        outputTransferSpectrum(fldi,t,1);
        outputTransferSpectrum(fldi,t,2);
#ifdef FORCING
        outputTkASpectrum(fldi,t,0);
        outputTkASpectrum(fldi,t,1);
        outputTkASpectrum(fldi,t,2);
        outputTkASpectrum(fldi,t,3);
        outputTkASpectrum(fldi,t,4);
        outputTkASpectrum(fldi,t,5);
        outputTkASpectrum(fldi,t,6);
        outputTkASpectrum(fldi,t,7);
  
		outputVH2Dspectrum(fldi,t);
#endif
*/
